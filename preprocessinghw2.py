...
https://github.com/dashapopova/Preprocessing-in-Python/blob/master/alice.txt
...
https://github.com/dashapopova/Preprocessing-in-Python/blob/master/googlebooks.txt
